...
const CoreRestoreCard = () => {
  ...
  return (
    <Card className="overflow-hidden bg-gradient-to-br from-blue-50 to-teal-50 border-blue-200 
                     hover:shadow-lg transition-all duration-300 relative group">
      {/* Hero Image with Play Button */}
      <div className="relative h-48 bg-gradient-to-br from-blue-400 to-teal-500 overflow-hidden">
        <img 
        ...
        <div className="absolute top-3 left-3 flex gap-2">
          <Badge variant="secondary" className="bg-white/90 text-blue-700 font-semibold">
            🧘‍♀️ Specialty
          </Badge>
