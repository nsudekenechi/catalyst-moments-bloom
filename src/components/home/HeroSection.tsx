...
const HeroSection = ({ onWatchVideo }: HeroSectionProps) => {
  return (
    <section className="pt-24 md:pt-32 pb-16 md:pb-24 overflow-hidden bg-gradient-to-br from-catalyst-cream via-catalyst-beige/30 to-catalyst-peach/20">
      <div className="container px-4 mx-auto">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0">
            <Badge variant="outline" className="mb-4 px-4 py-1.5 border-catalyst-copper/30 text-catalyst-copper">
              Made for Every Stage of Motherhood
            </Badge>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight leading-tight text-catalyst-brown">
              Your Wellness <span className="text-catalyst-copper">Journey</span> Through Motherhood
            </h1>
            <p className="text-lg mb-8 text-catalyst-brown/70 max-w-lg leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 mb-6">
              <Button asChild size="lg" className="font-medium rounded-full px-8 bg-catalyst-copper hover:bg-catalyst-brown text-white">
                <Link to="/dashboard">Get Started</Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="rounded-full border-catalyst-copper text-catalyst-copper hover:bg-catalyst-copper hover:text-white">
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="relative">
              ...
              <div className="relative z-10 rounded-2xl shadow-soft overflow-hidden max-w-sm md:max-w-md mx-auto">
                <AspectRatio ratio={4/5} className="bg-catalyst-beige">
                  <img 
