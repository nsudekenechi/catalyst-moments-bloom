    ...
    <section className="section-padding bg-white">
      <div className="container container-padding mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          />
          <div className="bg-gradient-to-br from-accent/10 to-accent/5 rounded-2xl p-7 flex flex-col items-center text-center shadow-soft">
            <div className="rounded-full bg-primary/10 p-3 mb-4">
              <div className="bg-primary rounded-full h-8 w-8 flex items-center justify-center text-primary-foreground font-bold">+</div>
            </div>
            ...
            <WellnessCoachButton variant="ghost" className="mt-auto text-primary hover:text-primary/90 hover:bg-primary/5" />
          </div>
        </div>
      </div>
    </section>
